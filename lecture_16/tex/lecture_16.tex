...
\frame{
	...
	\parbox{\textwidth}{
		Решив уравнения Навье-Стокса, мы найдем распределение ско\-рос\-ти и давления. Зная распределение скорости, из второй части находим распределение температуры. Дальше будут рассматриваться решения только первой части, уравнений Навье-Стокса.
	}
