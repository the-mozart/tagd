...
\frame{
	...
	\begin{exampleblock}{Связь тензора напряжений и тензора скоростей деформаций}
		\parbox{\textwidth}{
			...
			D_{1311} & D_{1322}  & D_{1333} & D_{1323} & D_{1313} & D_{1312} & D_{1332} & D_{1331} & D_{1321}\\
...
\frame{
	...
	\begin{exampleblock}{Ограничение на коэффициенты}
		...
		\begin{pmatrix}
			...
			0        & 0          & 0        & D_{2323} & 0        & 0        & D_{2332} & 0        & 0\\
			0        & 0          & 0        & 0        & D_{1313} & 0 	      & 0        & D_{1331} & 0\\
			0 		 & 0  		  & 0        & 0 		& 0        & D_{1212} & 0        & 0        & D_{1221}\\
			0 		 & 0  		  & 0 		 & D_{3223} & 0        & 0        & D_{3232} & 0        & 0\\
			0 		 & 0  		  & 0 		 & 0 		& D_{3113} & 0        & 0        & D_{3131} & 0\\
			0 		 & 0  		  & 0 		 & 0 		& 0    	   & D_{2112} & 0        & 0        & D_{2121}\\	
		\end{pmatrix}		
		\begin{pmatrix}
		e_{11} \\
		e_{22}\\
...
%				\end{pmatrix}
				\begin{pmatrix}
					...
					D_{1122} & D_{1111}   & D_{1122} &        0 & 0 	   & 0        & 0        & 0        & 0\\
					D_{1122} & D_{1122}   & D_{1111} &        0 & 0 	   & 0        & 0        & 0        & 0\\
					0        & 0          & 0        & D_{1212} & 0        & 0        & D_{1212} & 0        & 0\\
					0        & 0          & 0        & 0        & D_{1212} & 0 	      & 0        & D_{1212} & 0\\
					0 		 & 0  		  & 0        & 0 		& 0        & D_{1212} & 0        & 0        & D_{1212}\\
					0 		 & 0  		  & 0 		 & D_{1212} & 0        & 0        & D_{1212} & 0        & 0\\
					0 		 & 0  		  & 0 		 & 0 		& D_{1212} & 0        & 0        & D_{1212} & 0\\
					0 		 & 0  		  & 0 		 & 0 		& 0    	   & D_{1212} & 0        & 0        & D_{1212}\\	
				\end{pmatrix}	
	...
	\frametitle{ Вязкий сжимаемый теплопроводный газ }
		...
		\parbox{\textwidth}{
			\begin{enum} %[partopsep=1pt,label=\arabic{enumi})]
				...
				\[
				\sigma_{ij} = \left(
								-p + \left(\lambda+\frac{2}{3} \mu 
							\right) \operatorname{div}\vec{v}\right) \delta_{ij} + 
								2  \mu \left(
								e_{ij} -\frac{1}{3}\delta_{ij}\operatorname{div}	\vec{v}
								\right),
				\]
				\[
				e_{ij} = \frac{1}{2}\left( \pd{v_i}{x_j}+\pd{v_j}{x_i} \right),
				\]
				где $\lambda$, $\mu$  -- коэффициенты Ляме; $e_{ij}$ -- тензор скоростей деформаций;
...
\frame{
	...
	\begin{exampleblock}{Параметры среды}
		\parbox{\textwidth}{
			$\lambda$, $\mu$ -- коэффициенты Ляме;  $\kappa$ -- коэффициент теплопроводности; $\vec{f}$ -- вектор массовых сил. 
