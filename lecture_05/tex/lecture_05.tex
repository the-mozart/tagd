...
\frame[plain]{
	...
	\parbox{\textwidth}{
		Вектор перемещений. Связь вектора перемещений, метрического тензора и тензора деформаций. Тензор скоростей деформации. Распределение скоростей в бесконечно малой частице. Теорема Коши-Гельмгольца. Свойства компонентов, главные значения и собственные векторы тензора скоростей деформаций.
	}
}
