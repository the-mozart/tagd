...
\frame{
	...
	\begin{exampleblock}{Описание}
		\smallskip
		\parbox{\textwidth}{
			По теореме Коши -- Гельмгольца о скорости деформируемой час\-тицы квадрат $I$  переходит в параллелограмм $II$ посредством сдвига вдоль оси $x$, поворота как твердого тела по указанной стрелке и чистой деформации в виде сжатия вдоль линии $\alpha$ и растяжения вдоль линии $\beta$.
