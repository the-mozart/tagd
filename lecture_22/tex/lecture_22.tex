...
%			\]
		...
		Последний вариант невозможен в силу того, что даёт нулевую скорость звука во всей области течения, поэтому любое автомодельное решение является волной Римана.	
		}
	\end{exampleblock}	
}
...
\frame{
	...
	\begin{itemize}[partopsep=1pt,label=\textbullet]
		\item 
			\textbf{Рождественский Б.Л., Яненко Н.Н.} {\em Системы квазилинейных уравнений и их приложения к газовой динамике}. Изд. 2-е, Главная редакция физ.-мат. лит. Изд. <<Наука>>, М., 1978.
