...
\title[]{Трехмерные осесимметричные потенциальные течения идеальной жидкости}
...
\frame{
	...
	\parbox{\textwidth}{
	Для трехмерных потенциальных течений идеальной жидкости, определенных в некоторой области пространства, справедливы следующие уравнения.	
	}
...
\frame{
	...
	\begin{exampleblock}{Источник}
		\parbox{\textwidth}{
		\[
		\varphi = -\frac{q}{4\pi} \frac{1}{\sqrt{r^2+z^2}}\quad\Rightarrow\quad
	...
	\begin{exampleblock}{Диполь}
		\parbox{\textwidth}{
			\[
			\varphi =  -\frac{M}{4\pi} \frac{z}{(\sqrt{r^2+z^2})^3}\quad\Rightarrow\quad
...
\frame{
	...
	\begin{exampleblock}{Метод источников и стоков}
		\parbox{\textwidth}{
			Рассмотрим на оси $Oz$ распределенные источники и стоки с плотностью распределения $\mu(\zeta)$, где $\zeta$ -- положение на оси $Oz$ между точками $A$ и $B$.
		}
	\end{exampleblock}
	
	
	\begin{exampleblock}{Функция тока от источников, распределенных вдоль оси $Oz$ }
		\parbox{\textwidth}{
			\[
...
\frame{
	...
	\begin{exampleblock}{Поверхность тела -- поверхность тока}
		\parbox{\textwidth}{
			...
			\frac{1}{2}V\tilde{r}(z),
			\]
			где $r=\tilde{r}(z)$ -- уравнение дуги $AB$; $z$ -- координата между точками $A$ и $B$.
		}
	\end{exampleblock}
...
\frame{
	...
	\begin{exampleblock}{Метод источников и стоков}
	\parbox{\textwidth}{
		Рассмотрим  диполи, распределенные на оси $Oz$, с плотностью распределения $\mu(\zeta)$, где $\zeta$ -- положение на оси $Oz$ между точками $A$ и $B$.
	}
	\end{exampleblock}\pause
