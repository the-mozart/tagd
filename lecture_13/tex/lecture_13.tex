...
\frame{
	...
	\parbox{\textwidth}{
		...
		\[
			...
			z = x + i y,
		\]
		определенный в рассматриваемой бесконечной области, связанный соответствующими условиями на бесконечности и границе с теломи и такой, что 
		\[
			\Delta \psi(x,y) = 0.
		\]
	}
...
\frame{
	...
	\begin{literature}
		\item
		{\em Валландер С.\,В.}
		Лекции по гидрофэромеханике. Учеб. пособие. Л. Изд-во Ленингр. ун-та, 1978. 296 с.
