...
\frame{
	...
	\parbox{\textwidth}{
		В силу произвольности $\omega_t$ и формулы дифференцирования 
		\[
...
\frame{
	...
	\begin{exampleblock}{Интегральная форма}
		\parbox{\textwidth}{
			...
			\]
			где $\varepsilon\argtxv$ -- внутренняя энергия единицы массы частицы сплошной среды; $\vec{q}\argtxv$ -- закон перетока тепла в сплошной среде.
		}
	\end{exampleblock}
